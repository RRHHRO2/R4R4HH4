...
namespace Proyecto.Controllers
{
    ...
    public class TipoDocumentoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdTipoDocumento,Nombre,Abreviatura")] TipoDocumento tipoDocumento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdTipoDocumento,Nombre,Abreviatura")] TipoDocumento tipoDocumento)
        {
            if (ModelState.IsValid)
            {
